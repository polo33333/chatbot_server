...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~bot-bot-module~customer-customer-module"], {
  /***/
  ...
  function srcAppSharedServicesBotsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BotService = function BotService(http) {
      ...
      this.getAllBots = function () {
        return _this52.http.get(_this52.baseUrl + 'Ai/Bots');
      };

      this.getById = function (botId) {
        return _this52.http.get(_this52.baseUrl + 'Ai/Bots/' + botId);
      };

      this.createBots = function (data) {
        return _this52.http.post(_this52.baseUrl + 'Ai/Bots', data, httpOptions);
      };

      this.removeBot = function (botId) {
        return _this52.http["delete"](_this52.baseUrl + 'Ai/Bots/' + botId);
      };
    };
...
//# sourceMappingURL=default~bot-bot-module~customer-customer-module-es5.js.map